...
const BathroomRenovation = () => {
  const images = [
    bathroomImage1,
    bathroomImage1, // Placeholder - will be replaced with actual photos
    bathroomImage1,
    bathroomImage1,
  ];
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-construction-600 max-w-3xl mx-auto">
            ...
            See our completed projects showcasing modern design and quality craftsmanship.
          </p>
        </div>
          ...
          {images.map((image, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                <img
                  src={image}
                  alt={`Bathroom renovation project ${index + 1}`}
